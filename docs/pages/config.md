...
| :------------------------- |:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------|:-------------------------|
| BASE_PATH                  | The base path for serving ColdFront. This enables serving ColdFront using custom sub-path.
...
| EMAIL_DEVELOPMENT_EMAIL_LIST                    | When `DEBUG==True`, all outgoing emails are sent to these addresses instead of their normal recipients                             | yes         | yes                      |

...
class AllocationModelCleanMethodTests(TestCase):
    ...
    def test_status_is_expired_and_start_date_before_end_date_no_error(self):
        ...
        start_date: datetime.date = datetime.datetime(year=2023, month=11, day=2, tzinfo=datetime.UTC).date()
    ...
    def test_status_is_expired_and_start_date_equals_end_date_no_error(self):
        ...
        start_and_end_date: datetime.date = datetime.datetime(year=1997, month=4, day=20, tzinfo=datetime.UTC).date()
    ...
    def test_status_is_active_and_start_date_before_end_date_no_error(self):
        ...
        start_date: datetime.date = datetime.datetime(year=2001, month=5, day=3, tzinfo=datetime.UTC).date()
    ...
    def test_status_is_active_and_start_date_equals_end_date_no_error(self):
        ...
        start_and_end_date: datetime.date = datetime.datetime(year=2005, month=6, day=3, tzinfo=datetime.UTC).date()

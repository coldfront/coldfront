...
from coldfront.core.allocation.views import AllocationRenewView, AllocationUsersAddView, AllocationUsersRemoveView
...
@receiver(allocation_activate_user, sender=AllocationUsersAddView)
...
@receiver(allocation_remove_user, sender=AllocationUsersRemoveView)

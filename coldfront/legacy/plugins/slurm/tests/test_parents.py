...
from coldfront.legacy.allocation.models import Allocation, AllocationUserStatusChoice
from coldfront.legacy.plugins.slurm.associations import SlurmCluster
from coldfront.legacy.resource.models import ResourceAttribute, ResourceAttributeType, ResourceType
from coldfront.legacy.test_helpers.factories import (
...
class AssociationTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        san_aat = AllocationAttributeTypeFactory(name="slurm_account_name", attribute_type=text_aat)
        sp_aat = AllocationAttributeTypeFactory(name="slurm_parent", attribute_type=text_aat)
        ...
        AllocationAttributeFactory(allocation=cls.a4, value="a3", **aat_kwargs)
        AllocationAttributeFactory(allocation=cls.a5, value="a3", **aat_kwargs)
        AllocationAttributeFactory(allocation=cls.a6, value="a5", **aat_kwargs)
        AllocationAttributeFactory(allocation=cls.a8, value="a7", **aat_kwargs)

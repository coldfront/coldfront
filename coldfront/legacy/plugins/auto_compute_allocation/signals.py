...
from coldfront.legacy.project.signals import project_new
from coldfront.legacy.project.views import ProjectCreateView
...
def project_new_auto_compute_allocation(sender, **kwargs):
    ...
    async_task(
        "coldfront.legacy.plugins.auto_compute_allocation.tasks.add_auto_compute_allocation",
        project_obj,
    )

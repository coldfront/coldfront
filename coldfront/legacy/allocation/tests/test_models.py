...
class AllocationModelUserMethodTests(TestCase):
    ...
    @patch("coldfront.legacy.allocation.signals.allocation_activate_user.send")
    ...
    @patch("coldfront.legacy.allocation.signals.allocation_remove_user.send")
...
class AllocationModelExpiresInTests(TestCase):
    ...
    def test_end_date_in_three_years_without_leap_day_returns_days_including_no_leap_day(self):
        ...
        with patch("coldfront.legacy.allocation.models.datetime") as mock_datetime:

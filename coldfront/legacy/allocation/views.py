...
from coldfront.legacy.allocation.forms import (
...
from coldfront.legacy.allocation.signals import (
    allocation_activate,
...
from coldfront.legacy.allocation.utils import generate_guauge_data_from_usage, get_user_resources
from coldfront.legacy.project.models import Project, ProjectPermission
from coldfront.legacy.resource.models import Resource
from coldfront.legacy.utils.common import get_domain_url, import_from_settings
from coldfront.legacy.utils.mail import (
...
class AllocationDetailView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["display_slurm_help"] = "coldfront.legacy.plugins.slurm" in settings.INSTALLED_APPS

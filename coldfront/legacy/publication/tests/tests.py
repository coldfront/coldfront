...
import coldfront.legacy.publication
from coldfront.legacy.publication.models import Publication
from coldfront.legacy.publication.views import PublicationSearchResultView
from coldfront.legacy.test_helpers.decorators import (
    ...
    class Mocks:
        ...
        def patch(self):
            def dotpath(qualname):
                module_under_test = coldfront.legacy.publication.views

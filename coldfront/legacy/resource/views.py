...
from coldfront.legacy.resource.forms import ResourceAttributeCreateForm, ResourceAttributeDeleteForm, ResourceSearchForm
from coldfront.legacy.resource.models import Resource, ResourceAttribute
